#!/bin/bash
#Lrlrlr 300319 caliburHS.sh (HanSolo)
...
calibur.default.linuxgccrelease -pdb_list 10k_calibur.txt -strategy::thres_finder 1 -strategy::nofilter > calibur10k_1.calibur
